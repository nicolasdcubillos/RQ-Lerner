...
&&	oWorkbook.READONLY = .F.
	...
	* Validaciones del formato 
	...
	FOR lnRow = lcStartRow TO oSheet.UsedRange.ROWS.COUNT
		...
		lcSede = TRANSFORM(oSheet.Cells(lnRow, 11).VALUE)
		...
		lcResponsable = TRANSFORM(oSheet.Cells(lnRow, 13).VALUE)
		
		lcEstado = TRANSFORM(oSheet.Cells(lnRow, 14).VALUE)
