...
(
	...
	MVTRADE.NOMBRE,
	MVTRADE.CODCC,
	(SELECT MTPROCLI.DETALLE FROM MTMERCIA, MTPROCLI WHERE MTMERCIA.CODIGO = MVTRADE.PRODUCTO AND CAST(MTPROCLI.DETALLE AS VARCHAR(255))= MTMERCIA.CLASIFICA2) AS CODPROVEEDOR,
	MVTRADE.VALORUNIT,
	MVTRADE.DETALLE,
